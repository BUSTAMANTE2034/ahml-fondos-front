...
import { UpdateFund } from '@/lib/api/models/fund.js'
...
const UpdateFundModal = () => {
  ...
  const onSubmit = async (data: UpdateFund) => {
    ...
    <Modal visible onClose={closeEdit} className=" ">
      <div className="flex flex-col gap-4 px-2 md:px-4">
        ...
        <div className="text-center gap-2 flex flex-col">
          ...
          <p className="text-sm">Modifica los datos del fondo.</p>
        </div>
...
export default UpdateFundModal
