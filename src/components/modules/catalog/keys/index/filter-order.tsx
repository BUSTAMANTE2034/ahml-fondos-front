...
import FilterOrderCatalogKeys from "./order"
import { useKeys } from "./key-context"

const CatalogKeysOrderFilter = () => {
  const { order_by, setOrderBy } = useKeys()
...
export default CatalogKeysOrderFilter
