...
const DeleteDiagnosisCatalogModal = () => {
  const { 
    isDeleteOpen, 
    selected, 
    closeDelete, 
    ...
    <Modal visible onClose={closeDelete}>
      <div className="flex flex-col gap-4 px-2 md:px-4 text-center">
        ...
        <div className="text-center gap-2 flex flex-col">
          ...
          <p className="text-sm">
            Estás a punto de eliminar diagnóstico{' '}
            <strong>"{selected.detail}"</strong> ({selected.concept}).<br />
...
export default DeleteDiagnosisCatalogModal
