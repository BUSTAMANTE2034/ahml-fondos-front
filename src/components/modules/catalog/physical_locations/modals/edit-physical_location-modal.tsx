...
import { UpdatePhysicalLocation } from '@/lib/api/models/physical_location'
import { useEffect } from 'react'

const UpdatePhysicalLocationModal = () => {
  ...
  const {
    ...
    formState: { errors },
    reset,
  } = useForm<UpdatePhysicalLocation>()
  ...
  const onSubmit = async (data: UpdatePhysicalLocation) => {
    ...
    <Modal visible onClose={closeEdit} className=" ">
      <div className="flex flex-col gap-4 px-2 md:px-4">
        ...
        <div className="text-center gap-2 flex flex-col">
          ...
          <p className="text-sm">
            Modifica los datos de la ubicación física seleccionada.
          </p>
        </div>
...
export default UpdatePhysicalLocationModal
