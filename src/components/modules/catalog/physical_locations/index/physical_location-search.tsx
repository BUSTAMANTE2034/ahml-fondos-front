...
import { usePhysicalLocations } from './physical_location-context.js'

const SearchPhysicalLocation = () => {
  const { queryInput, setQuery } = usePhysicalLocations()
...
export default SearchPhysicalLocation
