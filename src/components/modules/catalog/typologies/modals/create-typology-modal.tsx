...
import { CreateTypology } from '@/lib/api/models/typology.js'
import { useState } from 'react'
import { addOneDay } from '@/components/ui/functions.js'

const CreateTypologyModal = () => {
  const { isCreateOpen, closeCreate, handleCreate, loadingCreate } = useTypologies()
  ...
  const onSubmit = async (data: CreateTypology) => {
    ...
    <Modal visible onClose={closeCreate} className=" ">
      <div className="flex flex-col gap-4 px-2 md:px-4">
        ...
        <div className="text-center gap-2 flex flex-col">
          ...
          <p className="text-sm">
            Ingresa los datos del tipología que deseas registrar.
          </p>
        </div>
...
export default CreateTypologyModal
