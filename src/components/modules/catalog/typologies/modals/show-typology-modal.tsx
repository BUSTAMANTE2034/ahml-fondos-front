...
const ShowTypologyModal = () => {
  const { selected, isShowOpen, closeShow } = useTypologies()
    ...
    <Modal visible onClose={closeShow}>
      <div className="flex flex-col gap-4 px-2 md:px-4">
        ...
        <div className="text-center flex flex-col gap-2">
          ...
          <p className="text-sm">Detalles de la tipología seleccionada</p>
        </div>
        ...
        <div className="flex flex-col gap-3 text-sm">
          ...
          <p>
            <span className="font-bold">Nombre de la Tipología: </span>
            {selected.name}
          </p>
...
export default ShowTypologyModal
