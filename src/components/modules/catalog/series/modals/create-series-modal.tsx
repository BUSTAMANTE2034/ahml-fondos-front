...
import { CreateSeries } from '@/lib/api/models/series.js'
...
const CreateSeriesModal = () => {
  const { isCreateOpen, closeCreate, handleCreate, loadingCreate } = useSeries()
  ...
  const onSubmit = async (data: CreateSeries) => {
    ...
    <Modal visible onClose={closeCreate} className=" ">
      <div className="flex flex-col gap-4 px-2 md:px-4">
        ...
        <div className="text-center gap-2 flex flex-col">
          ...
          <p className="text-sm">
            Ingresa los datos de la serie que deseas registrar.
          </p>
        </div>
