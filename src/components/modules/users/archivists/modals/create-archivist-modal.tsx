...
const CreateArchivistModal = () => {
  ...
  const {
    ...
    defaultValues: {
      role: 'archivist', // valor por defecto del select
    },
  })
    ...
    <Modal visible onClose={closeCreate} className=" ">
      <div className="flex flex-col gap-4 px-2 md:px-4">
        <div className="text-center gap-2 flex flex-col">
          ...
          <p className="text-sm">
            Ingresa los datos del archivista que deseas registrar.
          </p>
        </div>
        ...
        >
          <div className="w-full grid grid-cols-2 justify-between gap-4">
            <FormInput
              name="first_name"
              label="Nombres"
              placeholder="Nombre del archivista"
              register={register}
              errors={errors}
...
export default CreateArchivistModal
