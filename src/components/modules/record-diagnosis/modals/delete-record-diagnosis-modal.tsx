...
const DeleteRecordDiagnosisModal = () => {
  const {
    isDeleteOpen,
    selected,
    closeDelete,
  ...
  // Palabra requerida para permitir eliminar
    ...
    <Modal visible onClose={closeDelete}>
      <div className="flex flex-col gap-4 px-2 md:px-4 text-center">
        ...
        <div className="text-center gap-2 flex flex-col">
          ...
          <p className="text-sm">
            Estás a punto de eliminar la revisión del expediente{' '}
            <strong>
              {selected.record_file?.reference_code ?? 'Cargando...'}
            </strong>
            <br />
            Fecha de revisión:{' '}
            <strong>{invertDate(selected.revision_date)}</strong>
            <br />
...
export default DeleteRecordDiagnosisModal
